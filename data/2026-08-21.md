...
### [67] [Flow Matching-Based PET Image Reconstruction](https://arxiv.org/abs/2608.20112)
...
### [68] [Deep Learning for Automated Quantification of Tumor-Associated Macrophages from H&E-Stained Slides in Diffuse Large B-Cell Lymphoma](https://arxiv.org/abs/2608.19283)
...
### [69] [MOSAIC: A Self-supervised Dynamic Multi-encoding Reconstruction Framework for 3D Late Gadolinium Enhancement MRI](https://arxiv.org/abs/2608.19506)
...
### [70] [Loss-Resilient Semantic Communication over Packet-Loss Networks at Extreme-Low Bandwidth](https://arxiv.org/abs/2608.19590)
...
### [71] [AsymFeX: A Symmetry-Driven Framework for Ischemic Stroke Segmentation Across Imaging Modalities and Stroke Stages](https://arxiv.org/abs/2608.19769)
...
### [72] [MOSAIC: Modality-agnostic Spectral Alignment for Federated Image-level Weakly Supervised Tumor Segmentation under Client-specific Missing Modalities](https://arxiv.org/abs/2608.19788)
...
### [73] [Energy-Mamba: A Physics-Constrained State-Space Model for Medical Image Classification](https://arxiv.org/abs/2608.19813)
...
### [74] [Simulation-to-Real First-Break Segmentation for Efficient Inversion in Musculoskeletal Ultrasound Tomography](https://arxiv.org/abs/2608.19828)
...
### [75] [Simultaneous 3D co-registered perfusion and oxygenation with ULM, photoacoustic imaging, and a planar matrix array](https://arxiv.org/abs/2608.19823)
...
### [77] [The Missing Touch: Spatially Distributed Tactile Feedback Brings Teleoperation Closer to Human Dexterity](https://arxiv.org/abs/2608.19372)
...
### [78] [Learning the Right Abstraction: Neural Reduced Dynamics for Complex Robot Control](https://arxiv.org/abs/2608.19375)
...
### [79] [SCAPE: Scenario-Conditioned Simulation-Augmented Policy Evaluation](https://arxiv.org/abs/2608.19425)
...
### [80] [Hybrid Feedback Sampling for Sample-Efficient Model Predictive Control](https://arxiv.org/abs/2608.19443)
...
### [81] [When Automata Meet Streams: Temporal Logic Compilation for Stream-Based Robotics Task and Motion Planning](https://arxiv.org/abs/2608.19453)
...
### [82] [Fine-Tuning VLAs with Self-Demonstrated Generative Control for Multi-Task Manipulation](https://arxiv.org/abs/2608.19490)
...
### [83] [LF-GICP: Parameter-Free Degeneracy-Aware LiDAR Odometry via a Voxel-Normal Localizability Field](https://arxiv.org/abs/2608.19522)
*Eunsoo Im*
...
### [84] [Multimodal Trajectory Planning for Surface Vehicles using Turning Circle-based Control Barrier Functions](https://arxiv.org/abs/2608.19537)
*Changyu Lee*
...
### [85] [HiTac-WAM: A Hierarchical Tactile World Action Model for Contact-Rich Robot Manipulation](https://arxiv.org/abs/2608.19574)
...
### [86] [OrthoSkillVLA: Continual Skill Learning via Gradient-Informed Skill Subspace Adaptation](https://arxiv.org/abs/2608.19589)
...
### [87] [The Verification Gap in Networked Physical AI: A Post-Semantic Communication Framework](https://arxiv.org/abs/2608.19593)
*Shunsuke Saruwatari*
...
### [88] [What Matters for Latent Actions in Robot Learning](https://arxiv.org/abs/2608.19613)
...
### [89] [Magnetically Self-Sealed MR Haptic Actuator With PWM-Based Excitation and High-Fidelity Torque Control](https://arxiv.org/abs/2608.19635)
...
### [90] [World-Model-Grounded LLM Planning for AUV and ASV Navigation Near Offshore Wind Farms](https://arxiv.org/abs/2608.19661)
...
### [91] [SAGE: Ergodic Control for Autonomous and Adaptive Inspection of Subsea Infrastructure](https://arxiv.org/abs/2608.19671)
*Markus Buchholz,Ignacio Carlucho,Yvan R. Petillot*
...
### [92] [Keeping the Franka Emika Panda alive: a ROS 2 stack with a reliable position interface](https://arxiv.org/abs/2608.19740)
...
### [95] [MILD: Tractable Terrain Modeling for Learning Improved Bipedal Locomotion on Deformable Surfaces](https://arxiv.org/abs/2608.19955)
...
### [96] [PVRA: A Pointwise Key-point Voting Framework for Robotic Assembly](https://arxiv.org/abs/2608.19968)
...
### [97] [Learning Highly Dynamic Skills Transition for Quadruped Jumping Through Constrained Space](https://arxiv.org/abs/2608.19977)
...
### [98] [Evidence-Gated Task and Motion Planning with Vision-Language Models](https://arxiv.org/abs/2608.20084)
...
### [99] [Towards Professional Tennis Styles for Humanoid Robots with Adaptive Motion Planning and Tracking](https://arxiv.org/abs/2608.20087)
...
### [100] [Planning-Oriented End-to-End Autonomous Driving: Architectures, Evaluation, and Emerging Paradigms](https://arxiv.org/abs/2608.20111)
...
### [101] [Video2DoorTraversal: Push Door Traversal via Simulated Door Twins](https://arxiv.org/abs/2608.20251)
...
### [102] [DART-S: Reachability-Audited Active-Suspension Preconditioning for Off-Road Vehicle Jumps](https://arxiv.org/abs/2608.20275)
...
### [103] [MultiVerse: A Creator-Centered Approach to Steering Context-Adaptive Lyrics](https://arxiv.org/abs/2608.19350)
...
### [104] [Scientific Visualization as a Collaborative Data Infrastructure](https://arxiv.org/abs/2608.19413)
...
### [105] [Cyber-Physical Systems for Accessibility and Ability Augmentation: Bridging Diverse Communities](https://arxiv.org/abs/2608.19422)
...
### [106] [Does Listening Matter? Backchanneling and Nodding in AI Clone](https://arxiv.org/abs/2608.19527)
...
### [107] [Delegating or Doing? Understanding User Behavior in Hybrid Human-Agent Interfaces](https://arxiv.org/abs/2608.19551)
...
### [108] [Localized Ecological Momentary Assessment for Mental Health Research in China: An Implementation-Oriented Framework and Preliminary Case Application](https://arxiv.org/abs/2608.19588)
...
### [109] [IRIS: Navigating and Reflecting on Writing Traces Using Intelligent Document Histories](https://arxiv.org/abs/2608.19614)
...
### [110] [Grounding Mindfulness in Embodied Tangibles: A Scoping Review & Theoretical Framework for HCI Design](https://arxiv.org/abs/2608.19673)
...
### [111] [Calming Robot Pitches? Exploring the Influence of Robot Voice Pitch on Children's Stress Levels](https://arxiv.org/abs/2608.19826)
...
### [112] [Dancing Through Soundscapes: Designing a Low-Cost, Sound-Based Device for Sensing and Interpreting Movement and Dance](https://arxiv.org/abs/2608.19827)
...
### [113] [Evaluating Smart Home Device User Responses to their (Un)Confirmed Privacy Expectations](https://arxiv.org/abs/2608.19873)
...
### [114] [Designing Human-mediated AI Guidance: Ready Together for Personalized Family Emergency Preparedness](https://arxiv.org/abs/2608.19950)
...
### [115] [What Do Visualization Instructors Want Students to Learn? Introducing a Concept Inventory for Visualization Design](https://arxiv.org/abs/2608.20090)
...
### [116] [Navigating and Retrieving Information in Immersive Model-Based Design Reviews: An Exploratory Study](https://arxiv.org/abs/2608.20128)
