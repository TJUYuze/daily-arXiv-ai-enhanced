...
### [11] [Hidden In Plain Gaze: Gaze Representations as Privacy Controls for Utility and Re-identification Risk in XR](https://arxiv.org/abs/2609.04592)
...
### [13] [From Interpretability Methods to Interpretable Models](https://arxiv.org/abs/2609.05399)
...
### [38] [One Diffusion Model, Two Roles: Guided Trajectory Planning and Safety-Critical Scenario Generation in Closed-Loop Simulation](https://arxiv.org/abs/2609.04921)
...
### [39] [Weather-Conditioned Depth Anything](https://arxiv.org/abs/2609.04827)
...
### [40] [MINT: A Unified Model for World-Space Camera and Hand Motion Estimation from Scalable Egocentric Pipeline Supervision](https://arxiv.org/abs/2609.04958)
...
### [42] [CrossDepth: Geometry-Constrained Attention for Generalizable Multi-View Surround Depth Estimation](https://arxiv.org/abs/2609.05397)
...
### [43] [LetOccVote: Learning Weakly Supervised 3D Occupancy through Consensus](https://arxiv.org/abs/2609.04846)
...
### [44] [Mitigating Performance Discrepancy in Cross-Domain 3D Class-Incremental Learning](https://arxiv.org/abs/2609.04860)
...
### [45] [SimFuse3D: Source-Guided Target Simulation and Confidence-Guided Multi-Stage Localization Reweighting for Cross-Platform 3D Object Detection](https://arxiv.org/abs/2609.04886)
...
### [46] [InterSing: Explicit Interaction Dynamics for 3D Duet Singing Animation and Beyond](https://arxiv.org/abs/2609.04903)
...
### [47] [Methane Detection On Board Satellites from Unorthorectified Imagery](https://arxiv.org/abs/2609.04906)
...
### [48] [TourPhysics: Bringing Physics to World Models for Exploration and Manipulation from a Single Image](https://arxiv.org/abs/2609.04911)
...
### [49] [LensStyle: Learning the Optical Aesthetics for Controllable Stylized Lens Effect Rendering](https://arxiv.org/abs/2609.04939)
...
### [50] [Learning 3D Editing without Paired Supervision via Generative Prior Distillation](https://arxiv.org/abs/2609.04942)
...
### [51] [MCPO: Modality-Contrastive Preference Optimization for Multimodal Chain-of-Thought Compression](https://arxiv.org/abs/2609.04947)
...
### [52] [VICAL: Vicinal Consistency Alignment for Long-Tailed Visual Recognition](https://arxiv.org/abs/2609.04948)
...
### [71] [Compact Neural Appearance Models for Efficient Gaussian Splatting](https://arxiv.org/abs/2609.05255)
...
### [72] [Learning Spatial-Spectral Refinement and Calibrating Complementary Observations for Hyperspectral Image Super-Resolution](https://arxiv.org/abs/2609.05303)
...
### [73] [Adaptive Gated Deepfake Detection for Low-Resolution and Resource-Constrained Environments](https://arxiv.org/abs/2609.05320)
...
### [74] [Scalable Detection of Fossil Palynomorphs in Multifocal Digital Microscopy Images](https://arxiv.org/abs/2609.05323)
...
### [75] [Lightweight Vision Transformer Compression for On-Device Plant Disease Detection in Resource-Constrained Agricultural Field Conditions](https://arxiv.org/abs/2609.05334)
...
### [76] [MEOX: Compact Multimodal Mixture-of-Experts for Earth Observation](https://arxiv.org/abs/2609.05351)
*Mohanad Albughdadi*
...
### [77] [Reflection-aware Generative Novel View Synthesis](https://arxiv.org/abs/2609.05382)
...
### [78] [Think-Verify-Revise: Neuro-Symbolic Visual Reasoning with Vision-Language Models and Dynamic Logic Tensor Networks](https://arxiv.org/abs/2609.05388)
...
### [114] [BEAM3R: Beam's-eye-view architecture with Mamba-3 for implicit dose reconstruction](https://arxiv.org/abs/2609.04747)
...
### [115] [Attention-guided super-resolution of 4D flow MRI in carotid arteries](https://arxiv.org/abs/2609.04891)
...
### [116] [EyeMakeYou: Identity-, Task-, and Subjective-State-Conditioned Diffusion for High-Frequency Gaze Synthesis](https://arxiv.org/abs/2609.04501)
...
### [117] [Matched Starts, Divergent Objects: How Human-AI Collaboration Forms What It Explains](https://arxiv.org/abs/2609.04542)
...
### [118] [Beyond Prompt-to-App: Accountable Translation in Teacher-Facing Agentic Authoring](https://arxiv.org/abs/2609.04679)
...
### [119] [MIVAIS: A Study Environment for Multi-Agent Mixed-Initiative Visual Analytics Applications](https://arxiv.org/abs/2609.04983)
...
### [120] [How a Chatbot's Response Style Shapes a Classroom: A Multi-Agent Simulation of Students Consulting AI](https://arxiv.org/abs/2609.05018)
*Rin Tamai,Yuya Dan*
...
### [121] [Scales, Reflections, and Conversations: A Multi-Modal Approach to Emotion Annotation](https://arxiv.org/abs/2609.05046)
...
### [122] [Beyond Bias: Participatory and Reflective Approaches to Cultural AI](https://arxiv.org/abs/2609.05102)
...
### [123] [TherMosaic: Accelerating Perceived Thermal Transitions Through Spatiotemporal Thermal Feedback](https://arxiv.org/abs/2609.05347)
...
### [124] [Diffusion TV: Experiencing Diffusion Models through Tangible, Embodied Interaction](https://arxiv.org/abs/2609.05404)
*Sihwa Park*
...
### [125] [Scalable Neural Video Representation Compression](https://arxiv.org/abs/2609.04273)
...
### [126] [Multi-scale Image Representation Compression](https://arxiv.org/abs/2609.04274)
*Tianhao Peng,Ho Man Kwan,Fan Zhang,Shan Liu,David Bull*
...
### [127] [Cross-modal triage network: a multimodal deep learning framework for severity-based triage and visual explainability in chest radiographs](https://arxiv.org/abs/2609.04357)
...
### [128] [Ultrasound-Based Prediction of Cirrhosis Decompensation Using Large-Scale Computer Vision Models](https://arxiv.org/abs/2609.04365)
...
### [129] [Development and Evaluation of Ultrasound Image Learning Pipelines for MASLD Risk Stratification](https://arxiv.org/abs/2609.04390)
...
### [130] [Fractional-Order Adaptive Motion Magnification: Phase-Reliability Weighting for Noise-Constrained Video Amplification](https://arxiv.org/abs/2609.04502)
...
### [131] [Explainable Multimodal Deep Learning Integrating Imaging and Clinical Data for Oral Potentially Malignant Disorder Detection](https://arxiv.org/abs/2609.04512)
...
### [132] [Cross-dataset transportability of pediatric chest X-ray deep learning across three countries: discrimination, calibration, operating-point failure, and limited-label recovery](https://arxiv.org/abs/2609.05140)
*Nazim-E-Alam*
...
### [133] [Real-World Multi-Modal and Longitudinal Lung Cancer Dataset](https://arxiv.org/abs/2609.05202)
