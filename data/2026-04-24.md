...
### [11] [Do MLLMs Understand Pointing? Benchmarking and Enhancing Referential Reasoning in Egocentric Vision](https://arxiv.org/abs/2604.21461)
...
### [13] [Interpretable facial dynamics as behavioral and perceptual traces of deepfakes](https://arxiv.org/abs/2604.21760)
...
### [87] [Can Virtual Agents Care? Designing an Empathetic and Personalized LLM-Driven Conversational Agent](https://arxiv.org/abs/2604.20948)
...
### [88] [User-Centered Design of Hyperlocal Communication Platforms: Insights from the Design and Evaluation of KUBO](https://arxiv.org/abs/2604.20973)
...
### [89] [White Paper: Human-AI Collaboration in Conflict Analysis: Text Classifier Development with Peacebuilders](https://arxiv.org/abs/2604.21034)
...
### [90] [When Constraints Limit and Inspire: Characterizing Presentation Authoring Practices for Evolving Narratives](https://arxiv.org/abs/2604.21205)
...
### [91] [TopoStyle: Supporting Iterative Design with Generative AI for 2.5D Topology Optimization](https://arxiv.org/abs/2604.21315)
...
### [92] ["If We Had the Information That We Need to Interpret the World Around Us, We Wouldn't Be Disabled:" Barriers and Opportunities in Information Work among Blind and Sighted Colleagues](https://arxiv.org/abs/2604.21338)
...
### [93] [Neurodiversity and Technostress: Towards a Multimodal Research Design for Evaluating Subjective, Physiological, and Behavioral Responses](https://arxiv.org/abs/2604.21404)
...
### [94] [The Privacy Guardian Agent: Towards Trustworthy AI Privacy Agents](https://arxiv.org/abs/2604.21455)
*Vincent Freiberger*
...
### [95] [Gradual Voluntary Participation: A Framework for Participatory AI Governance in Journalism](https://arxiv.org/abs/2604.21878)
...
### [96] [Design, Modelling and Experimental Evaluation of a Tendon-driven Wrist Abduction-Adduction Mechanism for an upper limb exoskeleton](https://arxiv.org/abs/2604.20893)
...
### [97] [A Tendon-Driven Wrist Abduction-Adduction Joint Improves Performance of a 5 DoF Upper Limb Exoskeleton -- Implementation and Experimental Evaluation](https://arxiv.org/abs/2604.20898)
...
### [98] [Clinical Evaluation of a Tongue-Controlled Wrist Abduction-Adduction Assistance in a 6-DoF Upper-Limb Exoskeleton for Individuals with ALS and SCI](https://arxiv.org/abs/2604.20967)
*Juwairiya S. Khan,Mostafa Mohammadi,Alexander L. Ammitzbøll,Ellen-Merete Hagen,Jakob Blicher Izabella Obál,Ana S. S. Cardoso,Oguzhan Kirtas,Rasmus L. Kæseler,John Rasmussen,Lotte N. S. Andreasen Struijk*
...
### [99] [A Survey of Legged Robotics in Non-Inertial Environments: Past, Present, and Future](https://arxiv.org/abs/2604.20990)
...
### [100] [Open-H-Embodiment: A Large-Scale Dataset for Enabling Foundation Models in Medical Robotics](https://arxiv.org/abs/2604.21017)
...
### [101] [Neuro-Symbolic Manipulation Understanding with Enriched Semantic Event Chains](https://arxiv.org/abs/2604.21053)
*Fatemeh Ziaeetabar*
...
### [102] [Impact-Aware Model Predictive Control for UAV Landing on a Heaving Platform](https://arxiv.org/abs/2604.21078)
...
### [103] [Self-Predictive Representation for Autonomous UAV Object-Goal Navigation](https://arxiv.org/abs/2604.21130)
...
### [104] [Navigating the Clutter: Waypoint-Based Bi-Level Planning for Multi-Robot Systems](https://arxiv.org/abs/2604.21138)
...
### [106] [Full-Body Dynamic Safety for Robot Manipulators: 3D Poisson Safety Functions for CBF-Based Safety Filters](https://arxiv.org/abs/2604.21189)
...
### [107] [How VLAs (Really) Work In Open-World Environments](https://arxiv.org/abs/2604.21192)
...
### [108] [CorridorVLA: Explicit Spatial Constraints for Generative Action Heads via Sparse Anchors](https://arxiv.org/abs/2604.21241)
...
### [109] [Reasoning About Traversability: Language-Guided Off-Road 3D Trajectory Planning](https://arxiv.org/abs/2604.21249)
...
### [110] [FingerViP: Learning Real-World Dexterous Manipulation with Fingertip Visual Perception](https://arxiv.org/abs/2604.21331)
...
### [111] [PREVENT-JACK: Context Steering for Swarms of Long Heavy Articulated Vehicles](https://arxiv.org/abs/2604.21337)
...
### [112] [Learn Weightlessness: Imitate Non-Self-Stabilizing Motions on Humanoid Robot](https://arxiv.org/abs/2604.21351)
...
### [113] [RPG: Robust Policy Gating for Smooth Multi-Skill Transitions in Humanoid Fighting](https://arxiv.org/abs/2604.21355)
...
### [114] [A Deployable Embodied Vision-Language Navigation System with Hierarchical Cognition and Context-Aware Exploration](https://arxiv.org/abs/2604.21363)
...
### [115] [From Noise to Intent: Anchoring Generative VLA Policies with Residual Bridges](https://arxiv.org/abs/2604.21391)
...
### [116] [Ufil: A Unified Framework for Infrastructure-based Localization](https://arxiv.org/abs/2604.21471)
...
### [117] [MISTY: High-Throughput Motion Planning via Mixer-based Single-step Drifting](https://arxiv.org/abs/2604.21489)
...
### [118] [X2-N: A Transformable Wheel-legged Humanoid Robot with Dual-mode Locomotion and Manipulation](https://arxiv.org/abs/2604.21541)
...
### [119] [A Bayesian Reasoning Framework for Robotic Systems in Autonomous Casualty Triage](https://arxiv.org/abs/2604.21568)
...
### [120] [SLAM as a Stochastic Control Problem with Partial Information: Optimal Solutions and Rigorous Approximations](https://arxiv.org/abs/2604.21693)
...
### [121] [Effects of Swarm Size Variability on Operator Workload](https://arxiv.org/abs/2604.21707)
...
### [122] [A Compact Peristaltic Pump Based on Magneto-Elastic Hysteresis with Single Pneumatic Control](https://arxiv.org/abs/2604.21729)
...
### [123] [Hi-WM: Human-in-the-World-Model for Scalable Robot Post-Training](https://arxiv.org/abs/2604.21741)
...
### [124] [Task-Driven Co-Design of Heterogeneous Multi-Robot Systems](https://arxiv.org/abs/2604.21894)
...
### [125] [VistaBot: View-Robust Robot Manipulation via Spatiotemporal-Aware View Synthesis](https://arxiv.org/abs/2604.21914)
...
### [126] [EDU-Net: Retinal Pathological Fluid Segmentation in OCT Images with Multiscale Feature Fusion and Boundary Optimization](https://arxiv.org/abs/2604.20918)
...
### [127] [DiffNR: Diffusion-Enhanced Neural Representation Optimization for Sparse-View 3D Tomographic Reconstruction](https://arxiv.org/abs/2604.21518)
...
### [128] [Deep Reinforcement Learning for Optimizing Angle Selection and Dose Allocation in CT Reconstruction](https://arxiv.org/abs/2604.20939)
...
### [129] [Radiomics-Guided Vision Transformers for Survival Analysis](https://arxiv.org/abs/2604.21056)
*Qiyuan Shi,Yi Li*
...
### [130] [Explicit positronium source modeling for Geant4 PET pipelines: controlled 2-gamma and 3-gamma generation and validation](https://arxiv.org/abs/2604.21173)
*Jason G Parker*
...
### [131] [Flexible Piezoresistive Yarn Sensor for Human Physiological Signal Measurement](https://arxiv.org/abs/2604.21683)
...
### [132] [OptoCENTAL: a standardised, bench-testing platform based on phantoms for validating optical systems aimed at clinical monitoring of the placenta](https://arxiv.org/abs/2604.21747)
