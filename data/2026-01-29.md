...
### [63] [Treating symptoms or root causes: How does information about causal mechanisms affect interventions?](https://arxiv.org/abs/2601.20010)
*Romy Müller*
...
### [64] [Locatability and Locatability Robustness of Visual Variables in Single Target Localization](https://arxiv.org/abs/2601.20080)
...
### [65] [Editrail: Understanding AI Usage by Visualizing Student-AI Interaction in Code](https://arxiv.org/abs/2601.20085)
...
### [66] [Evaluating Actionability in Explainable AI](https://arxiv.org/abs/2601.20086)
...
### [67] [Taming Toxic Talk: Using chatbots to intervene with users posting toxic comments](https://arxiv.org/abs/2601.20100)
...
### [68] [Supporting Informed Self-Disclosure: Design Recommendations for Presenting AI-Estimates of Privacy Risks to Users](https://arxiv.org/abs/2601.20161)
...
### [69] [An Autonomous Agent Framework for Feature-Label Extraction from Device Dialogues and Automatic Multi-Dimensional Device Hosting Planning Based on Large Language Models](https://arxiv.org/abs/2601.20194)
...
### [70] [DiagLink: A Dual-User Diagnostic Assistance System by Synergizing Experts with LLMs and Knowledge Graphs](https://arxiv.org/abs/2601.20311)
...
### [71] [GuideAI: A Real-time Personalized Learning Solution with Adaptive Interventions](https://arxiv.org/abs/2601.20402)
...
### [72] [Remember Me, Not Save Me: A Collective Memory System for Evolving Virtual Identities in Augmented Reality](https://arxiv.org/abs/2601.20437)
*Tongzhou Yu,Han Lin*
...
### [73] [Chasing Meaning and/or Insight? A Survey on Evaluation Practices at the Intersection of Visualization and the Humanities](https://arxiv.org/abs/2601.20464)
...
### [74] [Piloting Planetarium Visualizations with LLMs during Live Events in Science Centers](https://arxiv.org/abs/2601.20466)
...
### [75] [Opportunities of Touch-Enabled Spherical Displays to support Climate Conversations](https://arxiv.org/abs/2601.20468)
...
### [76] [Beyond Literacy: Predicting Interpretation Correctness of Visualizations with User Traits, Item Difficulty, and Rasch Scores](https://arxiv.org/abs/2601.20544)
...
### [77] [SketchDynamics: Exploring Free-Form Sketches for Dynamic Intent Expression in Animation Generation](https://arxiv.org/abs/2601.20622)
...
### [78] [A Multi-Camera Optical Tag Neuronavigation and AR Augmentation Framework for Non-Invasive Brain Stimulation](https://arxiv.org/abs/2601.20663)
...
### [79] [Polite But Boring? Trade-offs Between Engagement and Psychological Reactance to Chatbot Feedback Styles](https://arxiv.org/abs/2601.20683)
...
### [80] [A Human-Centred AI System for Multi-Actor Planning and Collaboration in Family Learning](https://arxiv.org/abs/2601.20737)
...
### [81] [Learning to Live with AI: How Students Develop AI Literacy Through Naturalistic ChatGPT Interaction](https://arxiv.org/abs/2601.20749)
...
### [82] [ScaleFree: Dynamic KDE for Multiscale Point Cloud Exploration in VR](https://arxiv.org/abs/2601.20758)
...
### [83] [Exploring Re-inforcement Learning via Human Feedback under User Heterogeneity](https://arxiv.org/abs/2601.20760)
...
### [84] [Orthogonal Plane-Wave Transmit-Receive Isotropic-Focusing Micro-Ultrasound (OPTIMUS) with Bias-Switchable Row-Column Arrays](https://arxiv.org/abs/2601.20066)
...
### [85] [SegRap2025: A Benchmark of Gross Tumor Volume and Lymph Node Clinical Target Volume Segmentation for Radiotherapy Planning of Nasopharyngeal Carcinoma](https://arxiv.org/abs/2601.20575)
...
### [86] [Task-Based Adaptive Transmit Beamforming for Efficient Ultrasound Quantification](https://arxiv.org/abs/2601.20711)
...
### [87] [Leveraging Second-Order Curvature for Efficient Learned Image Compression: Theory and Empirical Evidence](https://arxiv.org/abs/2601.20769)
...
### [88] [E2HiL: Entropy-Guided Sample Selection for Efficient Real-World Human-in-the-Loop Reinforcement Learning](https://arxiv.org/abs/2601.19969)
...
### [89] [Just in time Informed Trees: Manipulability-Aware Asymptotically Optimized Motion Planning](https://arxiv.org/abs/2601.19972)
...
### [90] [Real-Time Robot Execution with Masked Action Chunking](https://arxiv.org/abs/2601.20130)
...
### [91] [A Taylor Series Approach to Correct Localization Errors in Robotic Field Mapping using Gaussian Processes](https://arxiv.org/abs/2601.20149)
...
### [92] [TRACER: Texture-Robust Affordance Chain-of-Thought for Deformable-Object Refinement](https://arxiv.org/abs/2601.20208)
...
### [93] [TouchGuide: Inference-Time Steering of Visuomotor Policies via Touch Guidance](https://arxiv.org/abs/2601.20239)
...
### [94] [Shallow-π: Knowledge Distillation for Flow-based VLAs](https://arxiv.org/abs/2601.20262)
...
### [95] [Tactile-Force Alignment in Vision-Language-Action Models for Force-aware Manipulation](https://arxiv.org/abs/2601.20321)
...
### [96] [Demonstration-Free Robotic Control via LLM Agents](https://arxiv.org/abs/2601.20334)
...
### [97] [RF-MatID: Dataset and Benchmark for Radio Frequency Material Identification](https://arxiv.org/abs/2601.20377)
...
### [98] [STORM: Slot-based Task-aware Object-centric Representation for robotic Manipulation](https://arxiv.org/abs/2601.20381)
...
### [99] [A Practical Framework of Key Performance Indicators for Multi-Robot Lunar and Planetary Field Tests](https://arxiv.org/abs/2601.20529)
...
### [100] [Vibro-Sense: Robust Vibration-based Impulse Response Localization and Trajectory Tracking for Robotic Hands](https://arxiv.org/abs/2601.20555)
...
### [101] [MeCo: Enhancing LLM-Empowered Multi-Robot Collaboration via Similar Task Memoization](https://arxiv.org/abs/2601.20577)
...
### [102] [GPO: Growing Policy Optimization for Legged Robot Locomotion and Whole-Body Control](https://arxiv.org/abs/2601.20668)
...
### [103] [Tendon-based modelling, estimation and control for a simulated high-DoF anthropomorphic hand model](https://arxiv.org/abs/2601.20682)
...
### [104] [One Step Is Enough: Dispersive MeanFlow Policy Optimization](https://arxiv.org/abs/2601.20701)
...
### [105] [Learning From a Steady Hand: A Weakly Supervised Agent for Robot Assistance under Microscopy](https://arxiv.org/abs/2601.20776)
...
### [106] [A Methodology for Designing Knowledge-Driven Missions for Robots](https://arxiv.org/abs/2601.20797)
...
### [107] [End-to-end example-based sim-to-real RL policy transfer based on neural stylisation with application to robotic cutting](https://arxiv.org/abs/2601.20846)
...
### [108] [Multicenter Comparison of Radionuclide Calibrators and SPECT/CT Protocols for Quantitative 177Lu Imaging in Clinical Practice](https://arxiv.org/abs/2601.20549)
