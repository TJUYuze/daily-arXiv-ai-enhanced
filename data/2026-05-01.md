...
### [85] [MAAS-SFRThelper: An Integrated ESAPI Plugin for Structure Generation, Optimization, and Evaluation of Spatially Fractionated Radiation Therapy](https://arxiv.org/abs/2604.27418)
...
### [86] [Wave-Equation Migration Velocity Analysis for Multistatic Synthetic Aperture Ultrasound](https://arxiv.org/abs/2604.27428)
...
### [96] [Design and Characteristics of a Thin-Film ThermoMesh for the Efficient Embedded Sensing of a Spatio-Temporally Sparse Heat Source](https://arxiv.org/abs/2604.28148)
...
### [97] [SASI: Leveraging Sub-Action Semantics for Robust Early Action Recognition in Human-Robot Interaction](https://arxiv.org/abs/2604.27508)
...
### [98] [Function-based Parametric Co-Design Optimization of Dexterous Hands](https://arxiv.org/abs/2604.27557)
...
### [99] [Robot Learning from Human Videos: A Survey](https://arxiv.org/abs/2604.27621)
...
### [100] [Can Tabular Foundation Models Guide Exploration in Robot Policy Learning?](https://arxiv.org/abs/2604.27667)
...
### [101] [ExoActor: Exocentric Video Generation as Generalizable Interactive Humanoid Control](https://arxiv.org/abs/2604.27711)
...
### [102] [Connected Dependability Cage: Run-Time Function and Anomaly Monitoring for the Development and Operation of Safe Automated Vehicles](https://arxiv.org/abs/2604.27728)
...
### [103] [MotuBrain: An Advanced World Action Model for Robot Control](https://arxiv.org/abs/2604.27792)
...
### [104] [Learning-Based Hierarchical Scene Graph Matching for Robot Localization Leveraging Prior Maps](https://arxiv.org/abs/2604.27821)
...
### [105] [Flying by Inference: Active Inference World Models for Adaptive UAV Swarms](https://arxiv.org/abs/2604.27935)
...
### [106] [Dreaming Across Towns: Semantic Rollout and Town-Adversarial Regularization for Zero-Shot Held-Out-Town Fixed-Route Driving in CARLA](https://arxiv.org/abs/2604.27994)
...
### [107] [Framework for Collaborative Operation of Autonomous Delivery Vehicles Within a Marshaling Yard](https://arxiv.org/abs/2604.28057)
...
### [108] [GSDrive: Reinforcing Driving Policies by Multi-mode Trajectory Probing with 3D Gaussian Splatting Environment](https://arxiv.org/abs/2604.28111)
...
### [109] [FreeOcc: Training-Free Embodied Open-Vocabulary Occupancy Prediction](https://arxiv.org/abs/2604.28115)
...
### [114] [Validating the Clinical Utility of CineECG 3D Reconstructions through Cross-Modal Feature Attribution](https://arxiv.org/abs/2604.27017)
...
### [115] [A Two Stage Pipeline for Left Atrial Wall Constrained Scar Segmentation and Localization from LGE-MR Images](https://arxiv.org/abs/2604.27101)
...
### [116] [Spectral Dynamic Attention Network for Hyperspectral Image Super-Resolution](https://arxiv.org/abs/2604.27326)
...
### [117] [A Real-time Scale-robust Network for Glottis Segmentation in Nasal Transnasal Intubation](https://arxiv.org/abs/2604.27383)
...
### [118] [Diffusion-OAMP for Joint Image Compression and Wireless Transmission](https://arxiv.org/abs/2604.27952)
...
### [119] [Quantifying the Cost of Manual Navigation: A Comparison of Gesture-Based Magnification versus Direct Access Reading in Digital Layout-based Documents](https://arxiv.org/abs/2604.27010)
...
### [120] [Breaking Bad Financial Habits: How LLM Conversations Correct Financial Misconceptions](https://arxiv.org/abs/2604.27022)
...
### [121] [What Influences Readers' and Writers' Perceived Necessity of AI Disclosure?](https://arxiv.org/abs/2604.27129)
...
### [123] [Upskilling with Generative AI: Practices and Challenges for Freelance Knowledge Workers](https://arxiv.org/abs/2604.27231)
...
### [124] [Evaluating Epistemic Guardrails in AI Reading Assistants: A Behavioral Audit of a Minimal Prototype](https://arxiv.org/abs/2604.27275)
...
### [125] [Beyond One-Size-Fits-All Exercises: Personalizing Computer Science Worksheets with Large Language Models](https://arxiv.org/abs/2604.27433)
...
### [126] [Why Learners Drift In and Out: Examining Intermittent Discontinuance in AI-Mediated Informal Digital English Learning (AI-IDLE) Using SEM and fsQCA](https://arxiv.org/abs/2604.27493)
*Yiran Du,Huimin He*
...
### [127] [From Elastic to Viscoelastic: An EEMD-Enhanced Pulse Transit Time Model for Robust Blood Pressure Estimation](https://arxiv.org/abs/2604.27500)
...
### [128] [Examining discontinuance of AI-mediated informal digital learning of English (AI-IDLE) among university students: Evidence from SEM and fsQCA](https://arxiv.org/abs/2604.27506)
*Yiran Du,Huimin He*
...
### [129] [I'm Fine, But My Voice Isn't: Cross-Modal Affective Dissonance Detection for Reflective Journaling](https://arxiv.org/abs/2604.27517)
*Sumin Lee*
...
### [130] [lpviz: Interactive Linear Programming Visualization](https://arxiv.org/abs/2604.27518)
...
### [131] [Knowledge Affordances for Hybrid Human-AI Information Seeking](https://arxiv.org/abs/2604.27539)
*Irene Celino*
...
### [132] [Users' Activity Logs: the Good, the Bad, the Misconception, and the Disastrous](https://arxiv.org/abs/2604.27676)
*Eman Alashwali*
...
### [133] [AgentEconomist: An End-to-end Agentic System Translating Economic Intuitions into Executable Computational Experiments](https://arxiv.org/abs/2604.27725)
...
### [134] ["It depends on where AI is used": Players' attitude patterns and evaluative logics toward different AI applications in digital games](https://arxiv.org/abs/2604.27812)
...
### [135] [CoNewsReader: Supporting Comprehensive Understanding and Raising Critical Thoughts on Social Media News Through Comments](https://arxiv.org/abs/2604.27905)
...
### [136] [Enhancing multimodal affect recognition in healthcare: the robustness of appraisal dimensions over labels within age groups and in cross-age generalisation](https://arxiv.org/abs/2604.27938)
...
### [137] [MyoKin3X: A Myoelectric Framework for Full-Hand 3D Force Recording](https://arxiv.org/abs/2604.27949)
...
### [138] [Real-Time Control of a Virtual Orchestra by Recognition of Conducting Gestures](https://arxiv.org/abs/2604.27957)
...
### [139] [When and How AI Should Assist Brainstorming for AI Impact Assessment](https://arxiv.org/abs/2604.27997)
...
### [140] [Essential, Yet Overlooked: Identity Verification Barriers for Blind and Low Vision People in Government Services](https://arxiv.org/abs/2604.28166)
