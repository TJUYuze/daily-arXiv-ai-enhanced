...
### [106] [FSP-Diff: Full-Spectrum Prior-Enhanced DualDomain Latent Diffusion for Ultra-Low-Dose Spectral CT Reconstruction](https://arxiv.org/abs/2602.07979)
...
### [107] [Continuity-driven Synergistic Diffusion with Neural Priors for Ultra-Sparse-View CBCT Reconstruction](https://arxiv.org/abs/2602.07980)
...
### [108] [Deepfake Synthesis vs. Detection: An Uneven Contest](https://arxiv.org/abs/2602.07986)
...
### [109] [MCIE: Multimodal LLM-Driven Complex Instruction Image Editing with Spatial Guidance](https://arxiv.org/abs/2602.07993)
...
### [110] [ForecastOcc: Vision-based Semantic Occupancy Forecasting](https://arxiv.org/abs/2602.08006)
...
### [111] [PhysDrape: Learning Explicit Forces and Collision Constraints for Physically Realistic Garment Draping](https://arxiv.org/abs/2602.08020)
...
### [112] [FlashVID: Efficient Video Large Language Models via Training-free Tree-based Spatiotemporal Token Merging](https://arxiv.org/abs/2602.08024)
...
### [113] [MIND: Benchmarking Memory Consistency and Action Control in World Models](https://arxiv.org/abs/2602.08025)
...
### [199] [Designing Multi-Robot Ground Video Sensemaking with Public Safety Professionals](https://arxiv.org/abs/2602.08882)
...
### [200] [Learning to Anchor Visual Odometry: KAN-Based Pose Regression for Planetary Landing](https://arxiv.org/abs/2602.06968)
...
### [201] [FeudalNav: A Simple Framework for Visual Navigation](https://arxiv.org/abs/2602.06974)
...
### [202] [LangGS-SLAM: Real-Time Language-Feature Gaussian Splatting SLAM](https://arxiv.org/abs/2602.06991)
...
### [203] [When Simultaneous Localization and Mapping Meets Wireless Communications: A Survey](https://arxiv.org/abs/2602.06995)
...
### [205] [Global Symmetry and Orthogonal Transformations from Geometrical Moment $n$-tuples](https://arxiv.org/abs/2602.07736)
*Omar Tahri*
...
### [206] [Research on a Camera Position Measurement Method based on a Parallel Perspective Error Transfer Model](https://arxiv.org/abs/2602.07888)
...
### [207] [Self-Supervised Bootstrapping of Action-Predictive Embodied Reasoning](https://arxiv.org/abs/2602.08167)
...
### [208] [Chamelion: Reliable Change Detection for Long-Term LiDAR Mapping in Transient Environments](https://arxiv.org/abs/2602.08189)
...
### [209] [Informative Object-centric Next Best View for Object-aware 3D Gaussian Splatting in Cluttered Scenes](https://arxiv.org/abs/2602.08266)
...
### [210] [BiManiBench: A Hierarchical Benchmark for Evaluating Bimanual Coordination of Multimodal Large Language Models](https://arxiv.org/abs/2602.08392)
...
### [211] [Reliability-aware Execution Gating for Near-field and Off-axis Vision-guided Robotic Alignment](https://arxiv.org/abs/2602.08466)
...
### [212] [Dexterous Manipulation Policies from RGB Human Videos via 4D Hand-Object Trajectory Reconstruction](https://arxiv.org/abs/2602.09013)
...
### [213] [Robustness Is a Function, Not a Number: A Factorized Comprehensive Study of OOD Robustness in Vision-Based Driving](https://arxiv.org/abs/2602.09018)
...
### [214] [$χ_{0}$: Resource-Aware Robust Manipulation via Taming Distributional Inconsistencies](https://arxiv.org/abs/2602.09021)
...
### [215] [U-Net Based Image Enhancement for Short-time Muon Scattering Tomography](https://arxiv.org/abs/2602.07060)
...
### [219] [MRI Cross-Modal Synthesis: A Comparative Study of Generative Models for T1-to-T2 Reconstruction](https://arxiv.org/abs/2602.07068)
...
### [220] [Exploring Polarimetric Properties Preservation during Reconstruction of PolSAR images using Complex-valued Convolutional Neural Networks](https://arxiv.org/abs/2602.07094)
...
### [221] [Extracting Root-Causal Brain Activity Driving Psychopathology from Resting State fMRI](https://arxiv.org/abs/2602.07233)
*Eric V. Strobl*
...
### [222] [Wavelet-Domain Masked Image Modeling for Color-Consistent HDR Video Reconstruction](https://arxiv.org/abs/2602.07393)
...
### [223] [Surveillance Facial Image Quality Assessment: A Multi-dimensional Dataset and Lightweight Model](https://arxiv.org/abs/2602.07403)
...
### [224] [DINO-Mix: Distilling Foundational Knowledge with Cross-Domain CutMix for Semi-supervised Class-imbalanced Medical Image Segmentation](https://arxiv.org/abs/2602.07819)
...
### [225] [A Unified Framework for Multimodal Image Reconstruction and Synthesis using Denoising Diffusion Models](https://arxiv.org/abs/2602.08249)
...
### [226] [Efficient Brain Extraction of MRI Scans with Mild to Moderate Neuropathology](https://arxiv.org/abs/2602.08764)
...
### [227] [Time-Resolved Multi-Spectral X-ray Computed Tomography of Cryoprotectant Diffusion Into Biomimetic Material](https://arxiv.org/abs/2602.07003)
...
### [228] [High-fidelity 3D multi-slab diffusion MRI using Slab-shifting for Harmonized 3D Acquisition and Reconstruction with Profile Encoding Networks (SHARPEN)](https://arxiv.org/abs/2602.07162)
...
Abstract: This study presents the first ex-vivo positronium imaging of human tissues using the modular J-PET scanner with the $^{44}$Sc radionuclide. The $^{44}$Sc isotope was produced via the $^{44}$Ca(p, n)$^{44}$Sc nuclear reaction and used to perform positronium imaging of phantom composed of human adipose tissue, cardiac myxoma tissue, thrombi blood clot, and also porous polymer XAD4, and a certified reference material (CRM) made from fused silica. The experiment demonstrates the suitability of $^{44}$Sc as a positron source for positronium imaging. The performance of J-PET for positronium imaging with $^{44}$Sc was validated by proper reconstruction of the mean orthopositronium lifetime for CRM material and XAD-4 polymer. The mean ortho-positronium (oPs) lifetimes determined for adipose tissue, cardiac myxoma tissues and thrombi were consistent with results of previous experiments. The study highlights the potential $^{44}$Sc radionuclide for positronium lifetime imaging (PLI).

</details>


### [230] [The Development of a Preclinical Alpha Irradiation Platform with Versatile Control of Dose, Dose Rate, and Spatiotemporal Irradiation Patterns](https://arxiv.org/abs/2602.07760)
*Harsh Arya,Joshua Rajan,Varghese Chirayath,Mainul Arbar,Awat Lotfihagh,Sitmukhambetov Satzhan,Yan Chang,Alex Weiss,Zui Pan,Yujie Chi*
...
### [232] [An in vivo validation dataset for dynamic volumetric MRI](https://arxiv.org/abs/2602.08918)
