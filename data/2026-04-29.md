...
### [29] [Personalized Cross-Modal Emotional Correlation Learning for Speech-Preserving Facial Expression Manipulation](https://arxiv.org/abs/2604.25255)
...
### [33] [OmniVTG: A Large-Scale Dataset and Training Paradigm for Open-World Video Temporal Grounding](https://arxiv.org/abs/2604.25276)
...
### [35] [The Thinking Pixel: Recursive Sparse Reasoning in Multimodal Diffusion Latents](https://arxiv.org/abs/2604.25299)
...
### [69] [Unsupervised Physics-Informed Deep Learning for Dual-Energy CT Material Decomposition](https://arxiv.org/abs/2604.25356)
...
### [70] [Effect of the dose distribution and organ architecture on the toxicity in FLASH radiotherapy: a modeling study](https://arxiv.org/abs/2604.25364)
*Juan Pardo-Montero*
...
### [71] [CRC-SAM: SAM-Based Multi-Modal Segmentation and Quantification of Colorectal Cancer in CT, Colonoscopy, and Histology Images](https://arxiv.org/abs/2604.24793)
*Daniel Lao*
...
### [72] [Generalizable 3D Gaussian Splatting enabled Semantic Coding for Real-Time Immersive Video Communications](https://arxiv.org/abs/2604.25330)
...
### [73] [Robustness Evaluation of a Foundation Segmentation Model Under Simulated Domain Shifts in Abdominal CT: Implications for Health Digital Twin Deployment](https://arxiv.org/abs/2604.25685)
*Sanghati Basu*
...
### [74] [MotionBricks: Scalable Real-Time Motions with Modular Latent Generative Model and Smart Primitives](https://arxiv.org/abs/2604.24833)
...
### [75] [VISION-SLS: Safe Perception-Based Control from Learned Visual Representations via System Level Synthesis](https://arxiv.org/abs/2604.24894)
...
### [76] [An analysis of sensor selection for fruit picking with suction-based grippers](https://arxiv.org/abs/2604.24906)
...
### [77] [asRoBallet: Closing the Sim2Real Gap via Friction-Aware Reinforcement Learning for Underactuated Spherical Dynamics](https://arxiv.org/abs/2604.24916)
...
### [78] [Libra-VLA: Achieving Learning Equilibrium via Asynchronous Coarse-to-Fine Dual-System](https://arxiv.org/abs/2604.24921)
...
### [79] [TEACar: An Open-Source Autonomous Driving Platform](https://arxiv.org/abs/2604.24934)
...
### [80] [DiscreteRTC: Discrete Diffusion Policies are Natural Asynchronous Executors](https://arxiv.org/abs/2604.25050)
...
### [81] [HANDFUL: Sequential Grasp-Conditioned Dexterous Manipulation with Resource Awareness](https://arxiv.org/abs/2604.25126)
...
### [82] [Dynamic UGV-UAV Cooperative Path Planning in Uncertain Environments](https://arxiv.org/abs/2604.25267)
...
### [83] [Optimal UGV-UAV Cooperative Partitioning and Inspection of Shortest Paths](https://arxiv.org/abs/2604.25284)
*Ninh Nguyen,Srinivas Akella*
...
### [84] [Slot-hopping Enabled Loiter Guidance and Automation for Fixed-wing UAV Corridors](https://arxiv.org/abs/2604.25292)
...
### [85] [ANCHOR: A Physically Grounded Closed-Loop Framework for Robust Home-Service Mobile Manipulation](https://arxiv.org/abs/2604.25323)
...
### [86] [ProDrive: Proactive Planning for Autonomous Driving via Ego-Environment Co-Evolution](https://arxiv.org/abs/2604.25329)
...
### [87] [Robust Graph Matching through Semantic Relationship Generation for SLAM](https://arxiv.org/abs/2604.25404)
...
### [88] [GS-Playground: A High-Throughput Photorealistic Simulator for Vision-Informed Robot Learning](https://arxiv.org/abs/2604.25459)
...
### [89] [Egocentric Tactile and Proximity Sensors as Observation Priors for Humanoid Collision Avoidance](https://arxiv.org/abs/2604.25554)
...
### [90] [Improving Sensing Coverage and Compliance of 3D-Printed Artificial Skins Through Multi-Modal Sensing and Soft Materials](https://arxiv.org/abs/2604.25563)
...
### [91] [SlicerRoboTMS: An Open-Source 3D Slicer Extension for Robot-Assisted Transcranial Magnetic Stimulation](https://arxiv.org/abs/2604.25661)
...
### [92] [GEGLU-Transformer for IMU-to-EMG Estimation with Few-Shot Adaptation](https://arxiv.org/abs/2604.25670)
...
### [93] [Learning-Based Dynamics Modeling and Robust Control for Tendon-Driven Continuum Robots](https://arxiv.org/abs/2604.25691)
...
### [94] [Reference-Augmented Learning for Precise Tracking Policy of Tendon-Driven Continuum Robots](https://arxiv.org/abs/2604.25698)
...
### [95] [Sensitivity-Based Tube NMPC for Cooperative Aerial Structures Under Parametric Uncertainty](https://arxiv.org/abs/2604.25766)
...
### [96] [KinDER: A Physical Reasoning Benchmark for Robot Learning and Planning](https://arxiv.org/abs/2604.25788)
...
### [97] [Privileged Foresight Distillation: Zero-Cost Future Correction for World Action Models](https://arxiv.org/abs/2604.25859)
...
### [98] [Variational Neural Belief Parameterizations for Robust Dexterous Grasping under Multimodal Uncertainty](https://arxiv.org/abs/2604.25897)
...
### [99] [Vega-Video: Integrating Video into the Grammar of Graphics](https://arxiv.org/abs/2604.24958)
...
### [100] [What If We Work Together? Fostering Reflections on Designer Inclusion in Open Source Software Through Speculative Design](https://arxiv.org/abs/2604.24981)
...
### [101] ["We Wanted to Do Better Than the Law": Exploring UI/UX Designers' Privacy Advocacy in Practice](https://arxiv.org/abs/2604.24982)
...
### [102] [AFA: Identity-Aware Memory for Preventing Persona Confusion in Multi-User Dialogue](https://arxiv.org/abs/2604.25022)
...
### [103] [Feature Anchors for Time-Series Sensor-Based Human Activity Recognition](https://arxiv.org/abs/2604.25092)
...
### [104] [People, IT, and Structuration (PIS): An Integrative Theoretical Framework for Management Information Systems](https://arxiv.org/abs/2604.25118)
...
### [105] [Value-Sensitive AI for Prayer: Balancing the Agencies Between Human and AI Agents in Spiritual Context](https://arxiv.org/abs/2604.25230)
...
### [106] [Visual Boosting Techniques for Spatiotemporal Dense Pixel Visualizations](https://arxiv.org/abs/2604.25298)
...
### [107] [Author response to commentaries on H is for Human and How (Not) to Evaluate Qualitative Research in HCI](https://arxiv.org/abs/2604.25312)
*Andy Crabtree*
...
### [108] [Co-Writing with AI: An Empirical Study of Diverse Academic Writing Workflows](https://arxiv.org/abs/2604.25389)
...
### [109] [Rewiring Perceived Doability in VR: Hand Redirection as a Subtle Cross-Sensory Support for Sustained Practice](https://arxiv.org/abs/2604.25443)
...
### [110] [Generative UI as an Accessibility Bridge: Lessons from C2C E-Commerce](https://arxiv.org/abs/2604.25455)
*Bektur Ryskeldiev*
...
### [111] [Making the Invisible Visible: Toward Micro-Expression Visualization for Empathy in Social Interaction](https://arxiv.org/abs/2604.25505)
...
### [112] [Emotive Architectures: The Role of LLMs in Adjusting Work Environments](https://arxiv.org/abs/2604.25601)
...
### [113] [ClayScape: A GenAI-Supported Workflow for Designing Chinese Style Ceramics with Clay 3D Printing](https://arxiv.org/abs/2604.25657)
...
### [114] [Designing and Evaluating Next-Generation Learning Interfaces: Linking AI, HCI, and the Learning Sciences](https://arxiv.org/abs/2604.25721)
...
### [115] [Lexical Anthropomorphization Influences on Moral Judgments of AI Bad Behavior](https://arxiv.org/abs/2604.25814)
...
### [116] ["The Worst Weather In America": Augmenting the Information Design of Extreme Cold Weather Forecasts](https://arxiv.org/abs/2604.25818)
